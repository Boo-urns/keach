        ...
        <div class="single-portfolio-entry">
                ...
                if($portfolio_button1text || $portfolio_button2text) { ?>
                        ...
                        <?php if($portfolio_button1text) { ?>
                                <li><a href="<?php echo $portfolio_button1url; ?>" <?php if ($target) { ?> target="_blank" <?php } ?>  class="button1" style="background:<?php echo $portfolio_button1color;  ?>;"><?php echo $portfolio_button1text; ?></a></li>
                        <?php } ?>
